#!/bin/bash
#SBATCH --qos=normal
#SBATCH --job-name=e-T6                                # Job Name
#SBATCH -o LOG_eq                                   # Log file
#SBATCH --time=24:00:00                             # WallTime
#SBATCH --nodes=1                                   # Number of Nodes
#SBATCH --mem=64000
#SBATCH --exclude=cypress01-006,cypress01-007,cypress01-036,cypress01-046,cypress01-049,cypress01-050,cypress01-051,cypress01-052,cypress01-072,cypress01-060
